<div class="form-group">
    ...
    <input type="text" name="name" class="form-control" id="name" value="{{ $departement->name }}"
...
<div class="form-group" hidden>
    ...
    <input type="text" name="slug" class="form-control" id="slug" value="{{ $departement->slug }}" placeholder="Slug">
